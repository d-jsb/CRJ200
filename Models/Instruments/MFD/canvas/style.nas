...
canvas.NDStyles["Airbus"] = {
	...
	svg_filename: get_local_path("res/bombardierND.svg"),
	##
	...
	layers: [
		...
		{ 
			...
			style: {
				svg_path: get_local_path("res/bombardierAirplane.svg"),
				#translate: [-45,-52]
			},
			options: {
				model: {
	...
	features: [
		...
		}, # of eta
		{
			...
			impl: {
				init: func(nd,symbol),
				predicate: func(nd) 1==1,
				is_true: func(nd) {
					var h = getprop("/sim/time/utc/hour");
					var m = getprop("/sim/time/utc/minute");
					nd.symbols.utc.setText(sprintf("%02d:%02d",h,m));
					nd.symbols.utc.show();
				},
				is_false: func(nd) nd.symbols.utc.hide(),
			},	# of eta.impl
		}, # of utc
		{
			id: "gsGroup",
